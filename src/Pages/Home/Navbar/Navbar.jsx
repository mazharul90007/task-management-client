...
const Navbar = () => {
    const { user, setUser, logOut, dayTheme, setDayTheme } = useAuth();
        ...
        <div className="bg-blue-100 shadow">
            <div className="py-2 w-11/12 mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center gap-1">
                    ...
                    {
                        user && <button onClick={handleLogOut} className="text-2xl bg-white p-1 border rounded border-gray-300 shadow-lg text-teal-600 font-bold cursor-pointer hover:bg-teal-500 hover:text-white"><MdOutlineLogout /></button>
                    }
                </div>
            </div>
        </div>
